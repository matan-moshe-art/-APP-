...
const PRESET_AVATARS = [
  createColorAvatar("#16a34a", "#ffffff", "A"),
  ...
  createColorAvatar("#0f766e", "#ffffff", "G"),
  createColorAvatar("#f43f5e", "#ffffff", "H"),
  createColorAvatar("#15803d", "#ffffff", "I"),
...
function NavAuthLinkInner({ variant = "full" }: { variant?: NavAuthVariant }) {
  ...
  return (
    <Link
      href="/auth/login"
      className="inline-flex min-h-9 items-center justify-center rounded-full border border-emerald-500/40 bg-emerald-600/20 px-4 text-sm font-semibold text-emerald-100 shadow-sm shadow-emerald-900/20 transition hover:border-emerald-400/60 hover:bg-emerald-600/35 hover:text-white"
    >
      כניסה
    </Link>
  );
